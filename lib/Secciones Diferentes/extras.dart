import 'package:app_calculadora_carbohidratos/OtherServices/calcular.dart';
...
class _ExtrasState extends State<Extras> {
  ...
  void cargarAlimentos() async {
    try {
      List<dynamic> datos = await ApiServices().CalcularCarbohidratos();
      setState(() {
        alimentos = datos;
      });
    } catch (e) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => Calcular(
          ...
          cantidades: [], cantidadesPorSeccion: {}, alimentosPorSeccion: {},
          glucemia: 0.0,
        ),
      ),
    );
