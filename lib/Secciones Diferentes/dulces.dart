import 'package:app_calculadora_carbohidratos/OtherServices/calcular3.dart';
import 'package:app_calculadora_carbohidratos/services/api_services3.dart';
import 'package:flutter/material.dart';

class Dulces extends StatefulWidget {
  const Dulces({super.key});
...
class _DulcesState extends State<Dulces> {
  ...
  void cargarAlimentos() async {
    try {
      List<dynamic> datos = await ApiServices3().CalcularCarbohidratos();
      setState(() {
        alimentos = datos;
      });
    } catch (e) {
