import 'package:app_calculadora_carbohidratos/OtherServices/calcular4.dart';
import 'package:app_calculadora_carbohidratos/services/api_services4.dart';
...
class _FrutasState extends State<Frutas> {
  ...
  void cargarAlimentos() async {
    try {
      List<dynamic> datos = await ApiServices4().CalcularCarbohidratos();
      setState(() {
        alimentos = datos;
      });
    } catch (e) {
