import 'package:app_calculadora_carbohidratos/OtherServices/calcular1.dart';
import 'package:app_calculadora_carbohidratos/services/api_services1.dart';
...
class _CerealesState extends State<Cereales> {
  ...
  void cargarAlimentos() async {
    try {
      List<dynamic> datos = await ApiServices1().CalcularCarbohidratos();
      setState(() {
        alimentos = datos;
      });
    } catch (e) {
